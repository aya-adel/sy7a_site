...
//$form->getElement('email')->setAttrib('disabled','disabled' );
    ...
    public function addreservationAction()
    {
        ...
        $form->getElement('city_id')->setValue($city_id);
...
// action body
    ...
    public function logInAction()
    {
        ...
        /*two key generated by application*/
//        $key='1NV6NlYxqddE1y4T3nzGE2vFi';
//        $scret='pjoERvoZKdbbRejsBzucnojatRZCo3pkRpGUZkKVgEL6YvH9Cn';
//        //estblish autho connection to server 
//        $connection = new TwitterOAuth($key,$scret);
//        //return token 
//        $token = $connection->oauth('oauth/request_token', array('oauth_callback' => 'http://fas7ny.iti.com/user/twitterlog'));
//        /*save autho_token , outh_token into session to use in the second page */
...
// write in session email & id & fname
    ...
    {
        $request_token = [];
        /*getting token , token secret from session to  reuse*/
        $request_token['oauth_token'] = $_SESSION['oauth_token'];
        $request_token['oauth_token_secret'] = $_SESSION['oauth_token_secret'];

        /*the API key , secret which generated by application*/
        $key='1NV6NlYxqddE1y4T3nzGE2vFi';
        $scret='pjoERvoZKdbbRejsBzucnojatRZCo3pkRpGUZkKVgEL6YvH9Cn';
        ...
        /* *create connection to getting token*/
        $connection = new TwitterOAuth($key,$scret, $request_token['oauth_token'], $request_token['oauth_token_secret']);
